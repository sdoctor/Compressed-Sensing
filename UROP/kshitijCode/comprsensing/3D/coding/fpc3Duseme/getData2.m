...
function [b,xs,xsn,picks] = getData2(L,m,n,k,Ameth,xmeth,d,varargin)
...
% generation of A matrix: commeneted: not required, using y=Ax from
% function handle
...
% add signal noise: We dont add noise since captured L already has Noise
% and we assume it to be sig2
...
% get noiseless measurments (or already noisy measurement of readymade
% light fields) b=Ax +n
f=@findingyAx;
b= f(L);
% 
