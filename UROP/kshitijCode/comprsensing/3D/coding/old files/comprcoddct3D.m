...
function [MeasFrac,SNR] = comprcoddct3D (I,Transform)
...
steps = 4; %% Total numbe ropf steps: Note, these steps are time expensive
meas = [ limit*1 limit*0.4 limit*0.3 limit*0.2]
