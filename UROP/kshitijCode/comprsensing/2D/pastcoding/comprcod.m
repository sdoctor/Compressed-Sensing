...
steps = 8; %% Total number of steps: Note, these steps are time expensive
meas = [ 1 0.75 0.6 0.4 0.3 0.2 0.1 0.05]
...
% set up the run
n = prod(size(Trow));
delta =meas(steps);            % m/n, m = round(delta*n)
